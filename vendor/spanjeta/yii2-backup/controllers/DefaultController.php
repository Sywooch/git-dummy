...
class DefaultController extends Controller
{
	...
	public function actionDelete($file = null)
	{
		...
		if ( isset($_GET['id']))
		{
			$mas = $this->get_files_array();
		 
			$sqlFile = $mas[$_GET['id']]['filepath'];
	...
	$list_files = glob($path .'*.sql');
		if ($list_files )
		{
			...
			foreach ( $list as $id=>$filename )
			{
				...
				$columns['filepath'] =  ( $path. $filename);
	...
	public function actionIndex()
	{
		...
		$dataProvider = new ArrayDataProvider(['allModels'=>$this->get_files_array() ]);
