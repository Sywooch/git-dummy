    ...
    $.fn.flexMenu = function (options) {
        var checkFlexObject,
            s = $.extend({
                ...
                'linkText' : '<div class="flex-menu menu_icon"></div>', // [string] What text should we display on the "view more" link?
                'linkTitle' : 'View More', // [string] What should the title of the "view more" button be?
                'linkTextAll' : 'ÐœÐµÐ½ÑŽ', // [string] If we hit the cutoff, what text should we display on the "view more" link?
