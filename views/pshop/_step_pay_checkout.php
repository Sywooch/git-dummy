...
<?php if($dataPost):?>
                        ...
                        ?>
                            ...
                            <div class="col-md-6 col-xs-12">
                                <div class="form-group"> <label for="" class="control-label">Имя и Фамилия</label>
                                    <p class="form-control-static"><?=$data['Rname']?></p>
                                </div>
                            ...
                            <div class="col-md-6 col-xs-12">
                                ...
                                <div class="form-group"> <button type="submit" class="btn btn-default">Завершить оформление заказа</button> </div>
                        </form>
<?php else: ?>
