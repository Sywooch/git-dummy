...
/* @var $dataProvider yii\data\ActiveDataProvider */
    ...
    $this->title = Yii::t('app', 'Активность');
...
<div class="center-content clearfix">
    ...
    <?    echo $this->render('@app/views/usermenu', ['title'=>Yii::t('app', 'Активность') ]); ?>
        ...
        <div class="content-filter clearfix">
            ...
            <div class="fr filter">
                <p>
                    ...
                    <input data-page="/activity" data-url="/activity/typethread" value="<?=\yii::$app->request->get('key')?>"  class="search_filter_input ma-search act1" data-place="" type="text">
                </p>
            </div>
...
<script>
    $('.p-l-30').change(function(){
       window.location='/activity?datefrom='+$('.p-l-20').val()+'&dateto='+$(this).val()+'&key='+$('.search_filter_input').val() ;
    });
</script>
