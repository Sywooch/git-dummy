...
echo		 Html::a(Yii::t('admin', '<span class="glyphicon glyphicon-tree-conifer"></span>'), ['/terms/default/create','parent'=>$term->terms_id], 
					[
						'class'=>'close various fancybox.ajax', 
						'data-fancybox-type'=>"ajax",
						'data-toggle'=>"tooltip",
...
echo		 Html::a(Yii::t('admin', '<span class="glyphicon glyphicon glyphicon glyphicon-align-justify"> </span>'),
					['mfield/index','Mfields[mfieldscatid]'=>$term->terms_id], 
					[
						'class'=>'close', 
						'data-toggle'=>"tooltip",
						'data-placement'=>"top", 
						'title'=>"Поля для данной категории",
						'style'=>'padding-left:50px;'
					]) ;

echo		 Html::a(Yii::t('admin', '<span class="glyphicon glyphicon glyphicon glyphicon-folder-open"> </span>'),
					['models/index','Models[modelscatid]'=>$term->terms_id],  
					[
						'class'=>'close', 
						'data-toggle'=>"tooltip",
						'data-placement'=>"top", 
						'title'=>"Модели данной категории",
						'style'=>'padding-left:50px;'
					]) ;								
