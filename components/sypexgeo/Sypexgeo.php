...
class Sypexgeo
{
    ...
    public function getCountry($lang='ru'){
        if($lang!='ru')
            $lang = 'en';

        return $this->country['name_'.$lang];
    }
    public function getCity($lang='ru'){
        if($lang!='ru')
            $lang = 'en';

        return $this->city['name_'.$lang];
    }
    /**
    ...
    {
        return new \app\components\sypexgeo\SxGeo();
    }
