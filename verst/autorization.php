...
<link rel="stylesheet" href="css/screen.css" type="text/css" meFdia="screen, projection">   
         ...
         <form class="authorisation-form">
            ...
            <div class="col-md-5 col-md-offset-4">
                ...
                <div class="grey-box1 clearfix">
                    ...
                    <div class="row">
                    	<div class="clearfix col-md-12 erorr_autorization">
                    		<div class="col-md-12">
                    			<p class="">Вы ввели не правильно Ник или пароль!</p>
                            ...
                            <div class="m-b-15 m-b-need">
                                <div class="clearfix row col-md-12 pad-none">
                                    <label class="check func-links">
                                        <input type="checkbox" />  Запомнить меня на этом компьютере 
                                    </label> 
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="tacenter func-links">
                                У Вас нет аккаунта? <a class="red-text" href="#"> Зарегистрируйтесь</a>
                            </div>
                        </div>
                    </div>
                </div>
