            ...
            <ul class="faq-list">
                <li class="opened">
                    ...
                    <div class="faq-list-text">
                        На этот вопрос ответа нет, но если что то очень хочется то это может быть. На этот вопрос ответа нет, но если что то очень хочется то это может быть.На этот
вопрос ответа нет, но если что то очень хочется то это может быть. На этот вопрос ответа нет, но если что то очень хочется то это может быть.
                    </div>
                </li>
                <li class="">
                    <div class="faq-list-title">
