    ...
    <div class="center-content clearfix">
        ...
        <div class="profile-right">
            <div class="content-filter clearfix">
                <div class="fl period">
                    <p class="show600 hidden-xs">ВЫБРАТЬ ПЕРИОД</p>
            ...
            <div class="date-time-list">
                <div class="date-time-list-header clearfix balance-header">
                    <div class="date-time-list-col dtlc-t1">
                        Основной счет: <span class="green-text">245.0 руб.</span>                 
                    </div>
                    <div class="date-time-list-col dtlc-t2">
                        Бонусы: <span class="red-text">+50</span>
                    </div>
                    <div class="date-time-list-col dtlc-t3">
                        <a href="#" class="button button-green">Пополнить счет</a>
                    </div>
                </div>
                ...
                <div class="date-time-list-row clearfix">
                    ...
                    <div class="date-time-list-col dtlc2-1">
                        Пополнение счета <span class="gray-text">VISA 5475****2342</span>
                    </div>
                    <div class="date-time-list-col dtlc3-1 small1-hide medium-hide">
                       2450.0 РУБ.
                    </div>
                    <div class="date-time-list-col dtlc3-1">
                        <span class="green-text">+125 бонус</span>
                    </div>
                ...
                <div class="date-time-list-row clearfix">
                    ...
                    <div class="date-time-list-col dtlc3-1 min-hide"> - </div>
                </div>
                <div class="date-time-list-row clearfix">
                    <div class="date-time-list-col dtlc1 clearfix">
                        <div class="date-time-list_date">
                    ...
                    <div class="date-time-list-col dtlc3-1 small-hide medium-hide">
                       2450.0 РУБ.
                    </div>
                    <div class="date-time-list-col dtlc3-1 min-hide">
