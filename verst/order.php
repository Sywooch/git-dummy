...
<header id="header">
            ...
            <div class="ct ft-aut1">
                ...
                <div class="lang1">
                    ...
                    <div class="curr1" dt="0">рус.</div>

                    <ul>

                        <li><a class="j1" href="">РУсский</a></li>

                        <li><a class="j2" href="">English</a></li>

                        <li><a class="j3" href="">Deutsch</a></li>

                    </ul>

                </div>

                <a href="" class="att2 j1">регистрация</a>

                <a href="" class="att1 j1">авторизация</a>

                <div class="bf2 bf22"></div>
                ...
                <div class="search1">
                    ...
                    <div class="poss-mob1" style="">
                        ...
                        <div class="ov-search1">
                            ...
                            <div><input type="text" class="et-srh1" value="ПОИСК" data-place="ПОИСК"></div>
                ...
                <div class="modal-ff1" style="left: 291px; width: 437px;">
                    ...
                    <div class="item-st1">
                        ...
                        <div class="ll1"><img src="img/sml1.png" alt=""></div>

                        <div class="rr1"><div><span>24%</span>еще собрать</div></div>

                        <div class="ov-tit1"><span><i>Iphone 6 Pl</i>us Белый</span></div>
                    ...
                    <div class="item-st1">
                        ...
                        <div class="ov-tit1"><span><i>Iphone 6 Pl</i>us Белый с перламутровыми пуговицами  чуток больше описания товар</span></div>
...
<div class="center-content content-page">
    ...
    <ul class="panel_group">
        <li class="panel opened">
            <div class="panel_heading">
                <div class="panel-title">Настройка аккаунта пользователя<a href="#" class="faq-list-toggle"></a></div>
            </div>
            <div class="panel_body">
                <div class="row">
                    <div class="col-sm-6">
                        <h3>Регистрация</h3>
                        <p>Я зарегистрированный пользователь</p>
                        <div class="for_radio"><input type="radio" name="in_account_cart" id="registration_radio" value="registration_radio" checked="checked"><label for="registration_radio">Зарегистрироватся</label></div>
                        
                        <div class="for_radio"><input type="radio" name="in_account_cart" id="guest_enter_radio" value="guest_enter_radio"><label for="guest_enter_radio">Гостевой вход</label></div>
                        <p>By creating an account you will be able to shop faster, be up to date on an order's status, and keep track of the orders you have previously made.</p>
                        <input type="button" value="Продолжить" id="button-account" data-loading-text="Loading..." class="button button-green">
                    </div>
                    <div class="col-sm-6">
                        <h3>Авторизация</h3>
                        <p>Я зарегистрированный пользователь</p>
                        <form class="authorisation-form">
                            ...
                            <div class="">
                                ...
                                <div class="clearfix">
                                    <div class="autorisation-row clearfix row">

                                        <div class="row">
                                              

                                           <div class="">
                                               <div class="autorisation-input main-type-input  input-succes">
                                    ...
                                    <div class="autorisation-row clearfix row">
                                        ...
                                        <div class="">
                                            <div class="autorisation-input-pswd main-type-input  input-error pass-holder">
                                                <input type="text" />
                                                <input type="password" placeholder="Пароль:"/>
                                                <span class="pass-holder-button forgotten_password">Забыли?</span>
                                            </div>

                                        </div>   
                                    </div>
                                    <input type="button" value="Войти" id="button-enter" data-loading-text="Loading..." class="button button-green">
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        <li class="panel">
            <div class="panel_heading">
                <div class="panel-title">Account & Billing Details<a href="#" class="faq-list-toggle"></a></div>
            </div>
            <div class="panel_body" id="collapse-payment-address">
                <div class="row">
                    <div class="col-sm-6">
                        <fieldset id="account">
                ...
                <div class="clear"></div>
                <form class="form-horizontal for_register_user" id="for_register_user_form_billing_details">
				    <div class="radio">
				    <label>
				  ...
				  <div id="payment-existing" style="display: block;">
				    <select name="address_id" class="form-control">
				                  <option value="1" selected="selected">yaroslav djamaspishvili, Ukrain, Kremenchug, Port of Spain, Trinidad and Tobago</option>
				                </select>
				  </div>
				  <div class="radio">
				    <label>
				  ...
				  <div class="buttons clearfix">
				    <div class="pull-right">
				      <input type="button" value="Continue" id="button-payment-address" data-loading-text="Loading..." class="button button-green">
				    </div>
				  </div>
				</form>
                <div class="clear"></div>         
        ...
        <li class="panel">
            <div class="panel_heading">
                <div class="panel-title">Delivery Details<a href="#" class="faq-list-toggle"></a></div>
            </div>
                ...
                <div class="panel_body">
                    <form class="form-horizontal">
                          <div class="form-group required">
                            ...
                            <div class="col-sm-10">
                              <input type="text" name="firstname" value="фвфы" placeholder="First Name" id="input-shipping-firstname" class="form-control">
                            </div>
                          </div>
                          <div class="form-group required">
                            <label class="col-sm-2 control-label" for="input-shipping-lastname">Last Name</label>
                            <div class="col-sm-10">
                              <input type="text" name="lastname" value="выфвфыв" placeholder="Last Name" id="input-shipping-lastname" class="form-control">
                            </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group required">
                            ...
                            <div class="col-sm-10">
                              <input type="text" name="address_1" value="ывфвфы" placeholder="Address 1" id="input-shipping-address-1" class="form-control">
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-sm-2 control-label" for="input-shipping-address-2">Address 2</label>
                            <div class="col-sm-10">
                              <input type="text" name="address_2" value="ыфвфывыфв" placeholder="Address 2" id="input-shipping-address-2" class="form-control">
                            </div>
                          </div>
                          <div class="form-group required">
                            <label class="col-sm-2 control-label" for="input-shipping-city">City</label>
                            <div class="col-sm-10">
                              <input type="text" name="city" value="фывфывыфв" placeholder="City" id="input-shipping-city" class="form-control">
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-sm-2 control-label" for="input-shipping-postcode">Post Code</label>
                            <div class="col-sm-10">
                              <input type="text" name="postcode" value="фывыфвфы" placeholder="Post Code" id="input-shipping-postcode" class="form-control">
                            </div>
                          </div>
                          <div class="form-group required">
                              ...
                              <select name="country_id" id="input-shipping-country" class="form-control">
                                <option value=""> --- Please Select --- </option>
                                                <option value="244">Aaland Islands</option>
                                                        ...
                                                        <option value="217">Turks and Caicos Islands</option>
                                                        <option value="218">Tuvalu</option>
                                                        <option value="219" selected="selected">Uganda</option>
                                                        <option value="220">Ukraine</option>
                                                        <option value="221">United Arab Emirates</option>
                          ...
                          <div class="form-group required">
                            ...
                            <div class="col-sm-10">
                              <select name="zone_id" id="input-shipping-zone" class="form-control"><option value=""> --- Please Select --- </option><option value="3452">Adjumani</option><option value="3453">Apac</option><option value="3454">Arua</option><option value="3437">Bugiri</option><option value="3465">Bundibugyo</option><option value="3466">Bushenyi</option><option value="3438">Busia</option><option value="3455">Gulu</option><option value="3467">Hoima</option><option value="3439">Iganga</option><option value="3440">Jinja</option><option value="3468">Kabale</option><option value="3469">Kabarole</option><option value="3441">Kaberamaido</option><option value="3424">Kalangala</option><option value="3425" selected="selected">Kampala</option><option value="3442">Kamuli</option><option value="3470">Kamwenge</option><option value="3471">Kanungu</option><option value="3443">Kapchorwa</option><option value="3472">Kasese</option><option value="3444">Katakwi</option><option value="3426">Kayunga</option><option value="3473">Kibaale</option><option value="3427">Kiboga</option><option value="3474">Kisoro</option><option value="3456">Kitgum</option><option value="3457">Kotido</option><option value="3445">Kumi</option><option value="3475">Kyenjojo</option><option value="3458">Lira</option><option value="3428">Luwero</option><option value="3429">Masaka</option><option value="3476">Masindi</option><option value="3446">Mayuge</option><option value="3447">Mbale</option><option value="3477">Mbarara</option><option value="3459">Moroto</option><option value="3460">Moyo</option><option value="3430">Mpigi</option><option value="3431">Mubende</option><option value="3432">Mukono</option><option value="3461">Nakapiripirit</option><option value="3433">Nakasongola</option><option value="3462">Nebbi</option><option value="3478">Ntungamo</option><option value="3463">Pader</option><option value="3448">Pallisa</option><option value="3434">Rakai</option><option value="3479">Rukungiri</option><option value="3435">Sembabule</option><option value="3449">Sironko</option><option value="3450">Soroti</option><option value="3451">Tororo</option><option value="3436">Wakiso</option><option value="3464">Yumbe</option></select>
                            </div>
                          </div>
                            <div class="buttons">
                            <div class="pull-right">
                              <input type="button" value="Continue" id="button-guest-shipping" data-loading-text="Loading..." class="button button-green">
                            </div>
                          </div>
                          <div class="clear"></div>
                    </form>
                    <form class="form-horizontal for_register_user" id="for_register_user_form_delivery_details">
					    <div class="radio">
					    <label>
					  ...
					  <div id="shipping-new" style="display: block;">
					        ...
					        <select name="country_id" id="input-shipping-country" class="form-control">
					          <option value=""> --- Please Select --- </option>
					                              <option value="244">Aaland Islands</option>
					                                        ...
					                                        <option value="211">Tokelau</option>
					                                        <option value="212">Tonga</option>
					                                        <option value="213" selected="selected">Trinidad and Tobago</option>
					                                        <option value="255">Tristan da Cunha</option>
					                                        <option value="214">Tunisia</option>
					                                        <option value="215">Turkey</option>
					                                        <option value="216">Turkmenistan</option>
					    ...
					    <div class="form-group required">
					      <label class="col-sm-2 control-label" for="input-shipping-zone">Region / State</label>
					      <div class="col-sm-10">
					        <select name="zone_id" id="input-shipping-zone" class="form-control"><option value=""> --- Please Select --- </option><option value="3287">Arima</option><option value="3289">Chaguanas</option><option value="3276">Couva/Tabaquite/Talparo</option><option value="3277">Diego Martin</option><option value="3278">Mayaro/Rio Claro</option><option value="3279">Penal/Debe</option><option value="3288">Point Fortin</option><option value="3285" selected="selected">Port of Spain</option><option value="3280">Princes Town</option><option value="3286">San Fernando</option><option value="3282">San Juan/Laventille</option><option value="3281">Sangre Grande</option><option value="3283">Siparia</option><option value="3290">Tobago</option><option value="3284">Tunapuna/Piarco</option></select>
					      </div>
					    </div>
					      </div>
					  <div class="buttons clearfix">
					    <div class="pull-right">
					      <input type="button" value="Continue" id="button-shipping-address" data-loading-text="Loading..." class="button button-green">
					    </div>
					  </div>
					</form>
        ...
        <li class="panel">
            <div class="panel_heading">
                <div class="panel-title">Delivery Method<a href="#" class="faq-list-toggle"></a></div>
            </div>
            <div class="panel-collapse collapse in" id="collapse-shipping-method" aria-expanded="true">
                <div class="panel_body">
                    ...
                    <div class="buttons">
                      <div class="pull-right">
                        <input type="button" value="Continue" id="button-shipping-method" data-loading-text="Loading..." class="button button-green">
                      </div>
                    </div> 
                    <div class="clear"></div>            
                </div>
        ...
        <li class="panel">
            <div class="panel_heading">
                <div class="panel-title">Payment Method<a href="#" class="faq-list-toggle"></a></div>
            </div>
            <div class="panel-collapse collapse in" id="collapse-payment-method" aria-expanded="true">
                <div class="panel_body"><p>Please select the preferred payment method to use on this order.</p>
                    <div class="radio">
                      <label>
                    ...
                    <p><strong>Add Comments About Your Order</strong></p>
                    <p>
                      <textarea name="comment" rows="8" class="form-control">asda</textarea>
                    </p>
                    <div class="buttons">
                      <div class="pull-right"><label for="agree">I have read and agree to the </label> <a href="http://ocart.96.lt/index.php?route=information/information/agree&amp;information_id=5" class="agree"><b>Terms &amp; Conditions</b></a>        <input type="checkbox" name="agree" value="1" id="agree">
                            &nbsp;
                        <input type="button" value="Continue" id="button-payment-method" data-loading-text="Loading..." class="button button-green">
                      </div>
                    </div>
                    <div class="clear"></div>
                </div>
        ...
        <li class="panel">
            <div class="panel_heading">
                <div class="panel-title">Confirm Order<a href="#" class="faq-list-toggle"></a></div>
            </div>
            <div class="panel-collapse collapse in" id="collapse-checkout-confirm" >
                <div class="panel_body">
                    <div class="table-responsive">
                      <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                                <tr>
                            <td class="text-left"><a href="http://ocart.96.lt/index.php?route=product/product&amp;product_id=41">iMac</a>
                                        </td>
                    ...
                    <div class="buttons">
                      <div class="pull-right">
                        <input type="button" value="Confirm Order" id="button-confirm" class="button button-green" data-loading-text="Loading...">
                      </div>
                    </div>
                    <div class="clear"></div>
                    </div>
			...
			<div class="center-content">
				<div class="row unmargined">
					<div class="footer-col-50p col-lg-3 col-md-3 col-sm-3 col-xs-3">
						...
						<ul class="hideon320">
							<li><a href="#">Что такое beActionner?</a></li>
							<li><a href="#">Год с нами</a></li>
						...
						<div class="showon320 showList prefooter_list">
							...
							<ul>
								...
								<li><a href="#">Доверие и сохранность</a></li>
					...
					<div class="mr_l_25 col-lg-5 col-md-5 col-sm-3 col-xs-3 hidelist">
						<div class="prefooter_list">
							...
							<ul class="cat">
								...
								<li><a href="#">Мода</a></li>
								<li><a href="#">Фильмы и видео</a></li>
								<li class="showhide-li hide-cat"><a href="#">Еда</a></li>
								<li class="showhide-li hide-cat"><a href="#">Игры</a></li>
								<li class="showhide-li hide-cat"><a href="#">Журналистика</a></li>
								<li class="showhide-li hide-cat"><a href="#">Музыка</a></li>
								<li class="showhide-li hide-cat"><a href="#">Фотографии</a></li>
								<li class="showhide-li hide-cat"><a href="#">Издательство</a></li>
    ...
    <div class="modal m2">
        <div class="modal-tb">
            ...
            <div class="modal-con">
                <div class="close"></div>
                <form action="#">
                    <p>Введите емейл для восстановления пароля и 
                       система автоматически отправит его Вам на почту.
                       Благодарим за использование нашего сервиса.</p>
                       <div class="line_form">
    ...
    $(document).ready(function () {
        $(document).on('change', 'input[name=in_account_cart]', function() {
            if ($('#collapse-payment-address').parent().find('.panel_heading .panel-title > *').is('a')) {
                if (this.value == 'registration_radio') {
                    $('#collapse-payment-address').parent().find('.panel_heading .panel-title').html('<div class="panel-title">Account & Billing Details</div>');
                } else {
                    $('#collapse-payment-address').parent().find('.panel_heading .panel-title').html('<div class="panel-title">Billing Details</div>');
                }
            } else {
                if (this.value == 'registration_radio') {
                    $('#collapse-payment-address').parent().find('.panel_heading .panel-title').html('Account &amp; Billing Details');
                } else {
                    $('#collapse-payment-address').parent().find('.panel_heading .panel-title').html('Billing Details');
                }
            }
        });
    })
