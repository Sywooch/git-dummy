            ...
            <div class="">
                ...
                <div class="grey-box1 clearfix">
                    <div class="autorisation-row clearfix row col-md-12">
                        <div class="col-md-12">
                            <div class="autorisation-input main-type-input  ">
                    ...
                    <div class="autorisation-row clearfix row col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="autorisation-input main-type-input  ok-icon-input  ok-true">
                    ...
                    <div class="autorisation-row clearfix row col-md-12 ">
                        ...
                        <div class="col-md-12">
                            <div class="autorisation-input main-type-input   ok-icon-input ok-false">
                    ...
                    <div class="autorisation-row clearfix row col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="autorisation-input main-type-input  ok-icon-input ">
                    ...
                    <div class="autorisation-row clearfix row col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="autorisation-input main-type-input ok-icon-input  ">
                                <input type="text" placeholder="Подтверждение e-mail:" />
                            </div>
                        </div>
                        <div class="clearfix erorr_autorization for-registration-error">
                            <div class="col-md-12">
                            ...
                            <div class="m-b-15 m-b-need">
                                <div class="clearfix row col-md-12 pad-none">
                                    <label class="check func-links">
                                        <input type="checkbox" /> By signing up, you agree to our <a class="red-text  fs-12" href="#">terms of use</a>,
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="tacenter func-links">
                                У Вас уже есть аккаунт?  <a class="red-text" href="#"> Авторизируйтесь</a>
                            </div>
                        </div>
                    </div>
                </div>
