...
(function($){
	$.fn.jNice = function(reinit){
		...
		return this.each(function(){
			...
			$('input.louder:checkbox', this).each(CheckAdd);
...
//			$wrapper.width(iw);
			if(typeof($input.attr('data-iscr'))!=='undefined'){
				$wrapper.addClass('iimg').append('<span class="imgNice"><img src="'+$input.attr('data-iscr')+'" alt=""/></span>');
			}
