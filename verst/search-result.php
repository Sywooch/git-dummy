...
<div class="block-search-page">
	<div class="center-content p-c-c-10 p-l">
	    <div class="menu-name">Поиск - mac</div>
	    <form action="#" class="search-form-for-result">
	        ...
	        <div class="filter-select-wrap ">
	            <div class="filter-selected">All categories</div>
	        ...
	        <label class="check func-links">
	            <div class="jq-checkbox"><input type="checkbox"><div class="jq-checkbox__div"></div></div>  Search in subcategories
	        </label>
	        <div class="clear"></div>
	        <label class="check func-links">
	            <div class="jq-checkbox2"><input type="checkbox"><div class="jq-checkbox__div2"></div></div>  Search in product description
	        </label>
	        <div class="clear"></div>
	        <input type="submit" value="ПОИСК" class="button-green button">
	    </form>
...
<div class="center-content m-b-50 p-c-c-10">
    <div class="row">
        ...
        <div class="unpadding-tacenter-on360  pull-right p-t-30 p-b-20 tarights filter-catalog-list">
            <span class="filter-name">Товаров на странице:</span>
            <div class="filter-select-wrap">
                <div class="filter-selected">21</div>
                <ul class="filter-select">
                    <li>
                        <a href="#">
                           22
        ...
        <div class="unpadding-tacenter-on360 pull-right p-t-30 p-b-20 taright filter-catalog-list">
            <span class="filter-name">Сортировать по:</span>
            <div class="filter-select-wrap ">
                <div class="filter-selected">Дате возрастающее</div>
                <ul class="filter-select">
                    <li>
                        <a href="#">
                            Дате возрастающее
        ...
        <div class="catalog-list-body clearfix">
            <div class="x3box m-b-50">
                <div class="catalog-item">
                    ...
                    <div class="bonus blue_bg"></div>
                    <div class="item_content">
                        <div class="name_item">
                            <a href="#"><span>Iphone 6 Plus Unlocked</span></a>
                        </div>
                        ...
                        <div class="done-range">
                            <div class="done-range-progressbar"></div>
                        </div>
